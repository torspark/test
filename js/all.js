...
(function(){
  ...
  app.controller('StoreController', [ '$http',function($http){
    //this.products = gems;
    var store = this;
    store.products = [ ]; //initalize w/ empty array just so there aren't errors when the page first loads while waiting for data.
  ...
  app.controller('ReviewController', function(){
    this.review = {};
    //this.review = {stars: 2, body: 'default', author: 'a@b.co'};
  ...
  var gems = [
    {
      ...
      images: [
        {
          full: 'dodo1-full.jpg',
          thumb: 'dodo1-thumb.jpg'
        },
        {
          full: 'dodo2-full.jpg',
          thumb: 'dodo2-thumb.jpg'
        }
      ],
      reviews: [
        {
...
(function(){
  ...
  app.directive('productPanels', function(){
    return {
      ...
      templateUrl: 'partial/product-panels',
      controller: function(){
        this.tab = 1; //1: desc, 2: specs, 3: reviews
  ...
  app.directive('productTitle', function(){
    return {
      restrict: 'E', //E for Element directive
      templateUrl: 'partial/product-title'
    };
  });
  ...
  app.directive('productReviews', function(){
    return {
      restrict: 'E', //E for Element directive
      templateUrl: 'partial/product-reviews'
    };
  });
  ...
  app.directive('productSpecs', function(){
    return {
      ...
      templateUrl: 'partial/product-specs'
    };
  });
})();
$(document).foundation();
